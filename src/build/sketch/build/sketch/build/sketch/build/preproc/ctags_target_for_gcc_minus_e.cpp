# 1 "/home/kuro/Documents/Programming/Robolid2018/src/Driver.cpp"
# 1 "/home/kuro/Documents/Programming/Robolid2018/src/Driver.cpp"
# 2 "/home/kuro/Documents/Programming/Robolid2018/src/Driver.cpp" 2
...
{
    int aux;
    if (((velocidad1)>0?(velocidad1):-(velocidad1)) + difL > velocidadMax)
    {
        aux = velocidadMax;
    }
    else if (((velocidad1)>0?(velocidad1):-(velocidad1)) + difL < velocidadMin)
    {
        aux = 0;
    }
    else
    ...
    int aux2;
    if (((velocidad2)>0?(velocidad2):-(velocidad2)) + difR > velocidadMax)
    {
        aux2 = velocidadMax;
    }
    else if (((velocidad2)>0?(velocidad2):-(velocidad2)) + difR < velocidadMin)
    {
        aux2 = 0;
    }
    else
...
# 1 "/home/kuro/Documents/Programming/Robolid2018/src/app.ino"


# 4 "/home/kuro/Documents/Programming/Robolid2018/src/app.ino" 2
...
void setup()
{
  ...
  {
    pinMode(MOTORS[i], 0x1);
    digitalWrite(MOTORS[i], 0x0);
  }
}
